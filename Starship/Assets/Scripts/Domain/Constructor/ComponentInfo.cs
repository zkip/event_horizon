...
namespace Constructor
{
	public struct ComponentInfo : IEquatable<ComponentInfo>
	{
		...
		public static ComponentInfo CreateRandom(IDatabase database, int level, Faction faction, System.Random random, bool allowRare, ComponentQuality maxQuality = ComponentQuality.P3, ComponentQuality minQuality = ComponentQuality.N3)
		{
			...
			var componentQuality = ComponentQualityExtensions.RandomizeRange(random, minQuality, maxQuality);
