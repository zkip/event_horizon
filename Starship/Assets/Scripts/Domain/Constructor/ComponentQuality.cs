...
namespace Constructor
{
	...
	public static class ComponentQualityExtensions
	{
		...
		public static ComponentQuality RandomizeRange(System.Random random, ComponentQuality maxQuality = ComponentQuality.P3, ComponentQuality minQuality = ComponentQuality.N3)
		{
			return (ComponentQuality)random.SquareRange((int)minQuality, (int)maxQuality);
		}
